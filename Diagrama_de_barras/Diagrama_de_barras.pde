...
void drawScatter()
{
  ...
  for (int i = 0; i < rowCount; i++) // desde la 0 hasta la 13
  {
      ...
      float x = map(i, 0, rowCount-1, 55, 515); //desde la 0 hasta la 13
      line(x, 80, x, 300);
  ...
  */
  ...
  for (int i = 0; i < rowCount; i++) //desde la 0 hasta la 13
  {
      ...
      //ellipse(x, y, 10,10);
      rect(x+10, y,10,300-y); //alto - el punto y
  ...
  */
  ...
  for (int i = 0; i < rowCount; i++) //desde la 0 hasta la 13
  {
      ...
      //ellipse(x, y, 10,10);
      rect(x+20, y,10,300-y); //alto - el punto y
  ...
  */
  ...
  for (int i = 0; i < rowCount; i++) //desde la 0 hasta la 13
  {
      ...
      //ellipse(x,y,10,10);
      rect(x+30, y,10,300-y); //alto - el punto y
      //println(i + "  " + Uff[i]  + "  " + x  + "  " + y);
  }
  /*  
  //poligono Uff
